...
json.listeners = {};
json.on = function(event, fn) {
  var listeners = json.listeners[event] || [];
  listeners.push(fn);
  json.listeners[event] = listeners; 
};

var fire = function() {
  var event = arguments[0],
      listeners = json.listeners[event] || [];
...
json.apply = function(snapshot, op) {
  ...
  for (var i = 0; i < op.length; i++) {
    ...
    // Object insert / replace
      ...
      elem[key] = c.oi;
      fire('set', c.p, elem, key, c.oi, old);
    }
